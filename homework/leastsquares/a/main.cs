...
public static class leastsquares{
	public static void Main(){
		...
		vector c = lsfit(fs,t,y,dy);				// returns solution coefficients c for reg plot
		vector clog = lsfit(fslog,t,ylog,dylog);		// returns solution coefficients c for log plot
